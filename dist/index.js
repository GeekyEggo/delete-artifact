...
const command_1 = __nccwpck_require__(832);
const file_command_1 = __nccwpck_require__(806);
const utils_1 = __nccwpck_require__(113);
const os = __importStar(__nccwpck_require__(37));
 ...
 * Summary exports
 */
var summary_1 = __nccwpck_require__(62);
Object.defineProperty(exports, "summary", ({ enumerable: true, get: function () { return summary_1.summary; } }));
/**
 * @deprecated use core.summary
 */
var summary_2 = __nccwpck_require__(62);
Object.defineProperty(exports, "markdownSummary", ({ enumerable: true, get: function () { return summary_2.markdownSummary; } }));
/**
 * Path exports
 */
var path_utils_1 = __nccwpck_require__(821);
...
const os = __importStar(__nccwpck_require__(37));
const uuid_1 = __nccwpck_require__(929);
const utils_1 = __nccwpck_require__(113);
...
const http_client_1 = __nccwpck_require__(381);
const auth_1 = __nccwpck_require__(36);
const core_1 = __nccwpck_require__(598);
class OidcClient {
...
const pm = __importStar(__nccwpck_require__(286));
const tunnel = __importStar(__nccwpck_require__(449));
var HttpCodes;
(function (HttpCodes) {
...
const pm = __nccwpck_require__(365);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
    HttpCodes[HttpCodes["OK"] = 200] = "OK";
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(449);
            }
            const agentOptions = {
...
var concatMap = __nccwpck_require__(227);
var balanced = __nccwpck_require__(967);
...
var expand = __nccwpck_require__(766)
...
var _v = _interopRequireDefault(__nccwpck_require__(27));

var _v2 = _interopRequireDefault(__nccwpck_require__(520));

var _v3 = _interopRequireDefault(__nccwpck_require__(858));

var _v4 = _interopRequireDefault(__nccwpck_require__(911));

var _nil = _interopRequireDefault(__nccwpck_require__(574));

var _version = _interopRequireDefault(__nccwpck_require__(970));

var _validate = _interopRequireDefault(__nccwpck_require__(770));

var _stringify = _interopRequireDefault(__nccwpck_require__(833));

var _parse = _interopRequireDefault(__nccwpck_require__(802));
...
var _rng = _interopRequireDefault(__nccwpck_require__(130));
...
var _v = _interopRequireDefault(__nccwpck_require__(458));

var _md = _interopRequireDefault(__nccwpck_require__(78));
...
var _sha = _interopRequireDefault(__nccwpck_require__(387));
...
var _regex = _interopRequireDefault(__nccwpck_require__(622));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getDefaultFilter = void 0;
const core = __importStar(__nccwpck_require__(598));
const minimatch_1 = __importDefault(__nccwpck_require__(602));
const utils_1 = __nccwpck_require__(825);
/**
 ...
 */
function getExactMatchFilter(names) {
    return function* filter(artifacts) {
 ...
 */
function getGlobMatchFilter(names) {
    const isMatch = (artifact) => names.some((pattern) => (0, minimatch_1.default)(artifact.name, pattern));
    return function* filter(artifacts) {
...
function getDefaultFilter() {
    const names = (0, utils_1.getInputMultilineValues)("name");
    return (0, utils_1.getInputBoolean)("useGlob")
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(598));
const runtime_http_client_1 = __importDefault(__nccwpck_require__(75));
const utils_1 = __nccwpck_require__(825);
const artifact_filter_1 = __nccwpck_require__(20);
/**
 * The main run function.
 */
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const client = new runtime_http_client_1.default();
        // get the artifacts
        const artifacts = yield client.listArtifacts();
        if (!artifacts.success) {
            (0, utils_1.fail)("Failed to load artifacts.");
            return;
        }
        let failureCount = 0;
        const filter = (0, artifact_filter_1.getDefaultFilter)();
        ...
        if (failureCount > 0) {
            (0, utils_1.fail)("1 or more artifacts failed to delete.");
        }
    });
}
run();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getInputMultilineValues = exports.getInputBoolean = exports.fail = void 0;
const core = __importStar(__nccwpck_require__(598));
/**
 ...
 */
function getInputMultilineValues(name) {
    return core.getInput(name)
        .split(/\r?\n/)
        .filter(name => name)
        .map(name => name.trim());
}
exports.getInputMultilineValues = getInputMultilineValues;
